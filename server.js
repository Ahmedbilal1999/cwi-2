...
MongoClient.connect("mongodb+srv://ahmedlehri99:colorsoflife2@cluster0.rd3ee2g.mongodb.net/", (err, client) => {
    if (err) {
        console.error('Error connecting to the database:', err);
    } else {
        const db = client.db('db_icw2');
        ...
        app.post('/collection/orders', (req, res) => {
            ...
            const ordersCollection = client.db(db_icw2).collection('order');
